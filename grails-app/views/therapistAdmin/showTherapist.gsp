 ...
 <body>  	
	...
	<div class="container">
		...
		<div class="page-header">
    		<h3>Therapist <small>Account details</small></h3>
    	</div>
	    ...
	    <g:form action="updateAccount" class="form-horizontal">
	    		<input type="hidden" 
	    				name="therapistId" 
	    				id="therapistId"
	    				value="${therapist.id}"/> 
				...
				<div class="control-group">
			    	...
			    	<div class="controls">
			    		<input type="password" id="password" name="password" placeholder="Password" value="0#0#">
			    	</div>			  
			    </div>
